...
<head>
  ...
  <title>
    {{config('app.name') }} | @yield('title', 'Bienvenido')
  </title>
  <!-- Favicon -->
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link nav-link-icon" href="{{route('login')}}">
                ...
                <span class="nav-link-inner--text">Iniciar Secion</span>
              </a>
            </li>
          </ul>
        </div>
        ...
        <div class="row align-items-center justify-content-xl-between">
          <div class="col-xl-6">
            <div class="copyright text-center text-xl-left text-muted">
              © 2025 <a href="/" class="font-weight-bold ml-1" target="_blank">{{config('app.name')}}</a>
            </div>
          </div>
          <div class="col-xl-6">
